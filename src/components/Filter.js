...
const Filter = () => {
  return (
    <div className="filter-wrapper w-1/2 bg-white dark:bg-dark-blue-dark relative mb-12 py-3 font-NunitoSans lg:w-1/6 h-14 max-w-xs shadow-md rounded flex items-center">
        <select className="form-select block  mt-1 px-2 text-very-dark-blue-light dark:bg-dark-blue-dark dark:text-white absolute right-0 w-full top-3 focus:outline-none">
